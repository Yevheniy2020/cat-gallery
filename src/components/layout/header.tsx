    ...
    <header className="h-60 sm:h-80 relative">
      ...
      {isBorderBlock && (
        <div className="absolute bottom-0 left-0 rounded-t-[60px] sm:rounded-t-full bg-zinc-900 h-24  sm:h-32 w-full">
          <div className="bg-gradient-to-r overflow-hidden w-full h-full sm:h-auto sm:w-auto text-center content-center px-12 py-2 rounded-t-[60px] sm:rounded-md  from-indigo-500 absolute text-lg left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 text-white">
